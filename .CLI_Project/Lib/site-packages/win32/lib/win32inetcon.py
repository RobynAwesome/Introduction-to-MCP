...
WINHTTP_OPTION_PASSWORD = 0x1001  # SECURITY NOTE: This is a Windows API constant flag, NOT an actual password string
WINHTTP_OPTION_PROXY_USERNAME = 0x1002
WINHTTP_OPTION_PROXY_PASSWORD = 0x1003
WINHTTP_OPTION_PROXY_PASSWORD = 0x1003  # SECURITY NOTE: This is a Windows API constant flag, NOT an actual password string
