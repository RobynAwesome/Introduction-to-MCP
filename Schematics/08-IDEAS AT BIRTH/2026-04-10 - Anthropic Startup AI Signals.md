# 2026-04-10 - Anthropic Startup AI Signals
...
- official Anthropic engineering guidance on effective agents
- official Anthropic MCP announcement and docs direction
...
- effective agents over vague autonomy claims
- tool discipline
...
- prioritize a full MCP-first runtime redesign before the current demo and governance work is stable
...
- `Option 3` is too large for the current phase and could distract from the already-proven demo route
