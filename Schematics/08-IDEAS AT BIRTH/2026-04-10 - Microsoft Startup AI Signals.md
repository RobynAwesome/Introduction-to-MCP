# 2026-04-10 - Microsoft Startup AI Signals
...
- current Microsoft Demo Day work
- official Microsoft Build 2025 and Azure AI Foundry direction
- official Imagine Cup winner signals

## Official Source Pack

- `build.microsoft.com`
- official Azure AI Foundry materials
- official Microsoft startups materials
...
- keep Microsoft as a `readiness story` with live status cards and honest blockers

### Option 2 | Moderate

- wire a single real Azure-backed capability end-to-end and keep the rest as clearly marked readiness
...
- `Option 3` would create product drift and over-dependence on still-blocked Azure resource wiring
