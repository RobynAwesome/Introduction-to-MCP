...
- Kopano-only demo route is written and rehearsed in [Kopano Demo Script - 2026-04-09](Kopano%20Demo%20Script%20-%202026-04-09.md).
...
- Kopano Labs already exposes the Microsoft readiness surface.
...
- The demo can still run on the Kopano-only safe route.
- If the full KasiLink path is not ready, present the Kopano shell and say the wider marketplace path is still being connected with production credentials and live data access.
...
Without the items below, the April 8 countdown row stays owner-blocked even though the repo, Kopano shell, and local rehearsal route are already working.
...
- [ ] approve the safe route in [Kopano Demo Script - 2026-04-09](Kopano%20Demo%20Script%20-%202026-04-09.md)
...
- KasiLink fallback: `Today we are showing the Kopano shell that powers the operating model while the wider KasiLink marketplace path finishes with production credentials and live data access.`
...
- [ ] open [Kopano Demo Script - 2026-04-09](Kopano%20Demo%20Script%20-%202026-04-09.md)
